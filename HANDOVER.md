...
**Test count: 196/196 backend tests passing** (48 Domain, 114 Application, 34 API integration; xUnit + NSubstitute + FluentAssertions) **+ 130/130 frontend tests passing** (Vitest, via `ng test`, up from 26 at the start of the audit — every feature component now has a spec file).
