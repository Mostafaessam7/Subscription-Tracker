...
Test counts after items 4–6 (item 7 added no new tests, it's a live verification pass): see the running total at the top of §2 (kept current there, not duplicated here to avoid drift between the two numbers).
